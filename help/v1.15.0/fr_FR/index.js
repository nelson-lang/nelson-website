...
window.searchIndex = [
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Single fournit des outils pour gérer les valeurs numériques en simple précision dans Nelson.</p> <p>Il permet la conversion de variables au format simple précision, permettant un stockage et un calcul efficaces tout en maintenant une précision numérique suffisante pour de nombreuses applications.</p> </chapter_description>",
  },
  {
    title: "single",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Type Sparse fournit des outils pour créer et manipuler des matrices creuses dans Nelson.</p> <p>Il prend en charge le stockage et le calcul efficaces pour les matrices avec un grand nombre d'éléments zéro, y compris la conversion entre les représentations creuses et pleines, la génération de matrices creuses spéciales, et l'accès aux éléments non nuls.</p> <p>Ce module permet une gestion efficace en mémoire de grands ensembles de données et des opérations numériques optimisées sur des structures creuses.</p> </chapter_description>",
  },
  {
    title: "IJV",
    url: "./sparse/IJV.html",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Fonctions Trigonométriques fournit un ensemble complet de fonctions pour effectuer des calculs trigonométriques dans Nelson.</p> <p>Il inclut les fonctions trigonométriques standards telles que sinus, cosinus et tangente, ainsi que leurs inverses et leurs homologues hyperboliques. Le module prend en charge les mesures d'angle en degrés et en radians, permettant des calculs flexibles selon les préférences de l'utilisateur.</p> <p>De plus, le module propose des fonctions utilitaires pour convertir entre degrés et radians, facilitant l'intégration des calculs trigonométriques dans diverses applications mathématiques et d'ingénierie.</p> </chapter_description>",
  },
  {
    title: "acos",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Fonctions Spéciales fournit des outils pour effectuer des opérations mathématiques avancées dans Nelson.</p> <p>Il inclut des fonctions pour les distributions statistiques, les calculs combinatoires, et d'autres calculs mathématiques spécialisés qui sont essentiels dans diverses applications scientifiques et d'ingénierie.</p> <p>Ce module améliore les capacités de Nelson en offrant une gamme de fonctions qui supportent des analyses complexes et des tâches de modélisation.</p> </chapter_description>",
  },
  {
    title: "betainc",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Statistiques fournit des outils pour analyser et résumer des données dans Nelson.</p> <p>Il comprend des fonctions pour calculer des mesures de tendance centrale, de variabilité, de corrélation et des distributions de probabilités.</p> <p>Le module prend également en charge des structures avancées de synthèse de données pour une estimation précise des quantiles, permettant une analyse statistique robuste et l'interprétation des jeux de données.</p> </chapter_description>",
  },
  {
    title: "corrcoef",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Traitement du signal fournit des outils pour analyser et manipuler des signaux échantillonnés dans Nelson.</p> <p>Il inclut des fonctions de fenêtrage, filtrage numérique, corrélation croisée, et des conversions entre représentations en magnitude, puissance et décibels.</p> <p>Le module prend également en charge la transformation entre représentations pôles-zéros et fonctions de transfert, permettant une conception et une analyse efficaces des systèmes de traitement du signal en temps discret.</p> </chapter_description>",
  },
  {
    title: "bartlett",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Random fournit des outils pour générer des nombres aléatoires et des séquences aléatoires dans Nelson.</p> <p>Il prend en charge les distributions uniforme et normale, la génération d'entiers aléatoires, les permutations et le contrôle de l'état du générateur de nombres aléatoires.</p> <p>Ce module est essentiel pour les simulations, la modélisation probabiliste et les calculs stochastiques.</p> </chapter_description>",
  },
  {
    title: "rand",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Stream Manager fournit des outils pour gérer les flux d'entrée et de sortie dans Nelson.</p> <p>Il prend en charge la lecture et l'écriture de données texte et binaires dans des fichiers, la gestion des positions dans les fichiers, la détection de la fin de fichier et la gestion des erreurs de fichier.</p> <p>Le module permet également la journalisation de l'activité de session ainsi que le chargement et la sauvegarde des données de l'espace de travail, facilitant des opérations d'E/S robustes et flexibles dans les scripts et applications.</p> </chapter_description>",
  },
  {
    title: "diary",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Feuille de calcul fournit des fonctions pour lire et écrire des données tabulaires depuis et vers des formats de feuille de calcul basés sur du texte, tels que CSV et les fichiers séparés par délimiteurs.</p> <p>Il prend en charge l'importation vers différents types de données comme les tableaux numériques, les cellules de chaînes et les tables, ainsi que leur exportation vers des fichiers.</p> <p>Cela permet une interaction fluide avec les logiciels de tableur (Excel, LibreOffice Calc, etc.) et l'échange de données entre applications.</p> </chapter_description>",
  },
  {
    title: "csvread",
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Le module Moteur QML permet aux programmes Nelson d'afficher, manipuler et interagir avec du contenu graphique en utilisant le framework QML de Qt.</p> <p>Il fournit des fonctions pour gérer les composants QML, accéder aux objets Qt et intégrer la logique JavaScript et QML.</p> </chapter_description>",
  },
  {
  ...
  },
  {
    ...
    content:
      "<chapter_description> <p>Ce module fournit des fonctions pour gérer les connexions, envoyer et recevoir des données, et gérer les événements dans un environnement cloud.</p> </chapter_description>",
  },
  {
    title: "sioemit",
